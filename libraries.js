    ...
    data.forEach((element) => {
      ...
      <div>
          ...
          <button class="btn btn-light dropdown-toggle" type="button" data-bs-toggle="collapse"
              data-bs-target="#${element.name}details" aria-expanded="false" aria-controls="${element.name}details"></button>
      </div>
  </div>
  <div class="collapse" id="${element.name}details">
      <div class="card card-body">
          Additional details about ${element.name} library:
      </div>
  </div>`;
    });
